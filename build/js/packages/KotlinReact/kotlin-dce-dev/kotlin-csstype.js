(function (root, factory) {
  ...
  function gridTemplateColumns($receiver, values) {
    $receiver.gridTemplateColumns = joinToString(values, ' ');
  }
  function gridTemplateRows($receiver, values) {
    $receiver.gridTemplateRows = joinToString(values, ' ');
  }
  ...
  var margin = defineInlineFunction('kotlin-csstype.csstype.margin_aukhgf$', function ($receiver, vertical, horizontal) {
    $receiver.margin = vertical.toString() + ' ' + horizontal;
  });
  var margin_0 = defineInlineFunction('kotlin-csstype.csstype.margin_a1epx6$', function ($receiver, top, horizontal, bottom) {
    $receiver.margin = top.toString() + ' ' + horizontal + ' ' + bottom;
  });
  var margin_1 = defineInlineFunction('kotlin-csstype.csstype.margin_r4c67z$', function ($receiver, top, right, bottom, left) {
    $receiver.margin = top.toString() + ' ' + right + ' ' + bottom + ' ' + left;
  });
  var Padding = defineInlineFunction('kotlin-csstype.csstype.Padding_61zpoe$', function (value) {
    return value;
  });
  var padding = defineInlineFunction('kotlin-csstype.csstype.padding_aukhgf$', function ($receiver, vertical, horizontal) {
    $receiver.padding = vertical.toString() + ' ' + horizontal;
  });
  var padding_0 = defineInlineFunction('kotlin-csstype.csstype.padding_a1epx6$', function ($receiver, top, horizontal, bottom) {
    $receiver.padding = top.toString() + ' ' + horizontal + ' ' + bottom;
  });
  var padding_1 = defineInlineFunction('kotlin-csstype.csstype.padding_r4c67z$', function ($receiver, top, right, bottom, left) {
    $receiver.padding = top.toString() + ' ' + right + ' ' + bottom + ' ' + left;
  });
  ...
  package$csstype.gridTemplateColumns_4iysj0$ = gridTemplateColumns;
  package$csstype.gridTemplateRows_ebul52$ = gridTemplateRows;
  ...
  package$csstype.margin_aukhgf$ = margin;
  package$csstype.margin_a1epx6$ = margin_0;
  package$csstype.margin_r4c67z$ = margin_1;
  package$csstype.Padding_61zpoe$ = Padding;
  package$csstype.padding_aukhgf$ = padding;
  package$csstype.padding_a1epx6$ = padding_0;
  package$csstype.padding_r4c67z$ = padding_1;
